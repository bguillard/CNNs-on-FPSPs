...
# Load numpy weights
with open('NP_WEIGHTS_three_layers_bin_reg_lrelu25.pck', 'rb') as f:
  (w1_values, b1_values, w2_1_values, b2_1_values, w2_2_values, b2_2_values, w2_3_values, b2_3_values, w3_1_values, w3_2_values, w3_3_values) = pickle.load(f)
...
third_layer = [w3_1_values[:,:,0,0], w3_2_values[:,:,0,0], w3_3_values[:,:,0,0]]
kernels = [first_layer, second_layer, third_layer]
