...
# Load numpy weights
with open('NP_WEIGHTS_four_layers_bin_reg_lrelu25.pck', 'rb') as f:
  (w1_values, b1_values,
   ...
   w4_1_values, w4_2_values, w4_3_values) = pickle.load(f)
...
fourth_layer = [w4_1_values[:,:,0,0], w4_2_values[:,:,0,0], w4_3_values[:,:,0,0]]
kernels = [first_layer, second_layer, third_layer, fourth_layer]
